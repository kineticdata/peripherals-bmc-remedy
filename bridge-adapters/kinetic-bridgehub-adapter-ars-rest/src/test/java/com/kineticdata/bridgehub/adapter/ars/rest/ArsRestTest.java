...
public class ArsRestTest extends BridgeAdapterTestBase{
    ...
    public void test_count() throws Exception{
        ...
        configValues.put("Username","KD_WEBUSER");
        configValues.put("Password", "KD_WEBUSER");
        configValues.put("URL Origin","https://baxter-dev-restapi.onbmc.com");
