...
class BmcItsm7ChangeWorkInfoCreateV4
  ...
  def initialize(input)
    ...
    preinitialize_on_first_load(
      @input_document,
      ['CHG:WorkLog', 'CHG:Infrastructure Change','KS_SRV_SurveyQuestion',
  ...
  def execute
    ...
    change_entry = @@remedy_forms['CHG:Infrastructure Change'].find_entries(
      :single,
    ...
    entry = @@remedy_forms['CHG:WorkLog'].create_entry!(
