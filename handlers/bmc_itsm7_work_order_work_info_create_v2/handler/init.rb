...
class BmcItsm7WorkOrderWorkInfoCreateV2
  ...
  def initialize(input)
    ...
    preinitialize_on_first_load(
      @input_document,
      ['WOI:WorkInfo', 'WOI:WorkOrder', 'KS_SRV_SurveyQuestion',
        'KS_SRV_QuestionAnswerJoin', 'KS_ACC_Attachment']
    )
  ...
  def profile_method(method)
    ...
    puts "Call to '#{method}' took #{end_time - start_time} milliseconds."
  end
  ...
  def execute
    ...
    # @field_values.
    profile_method("retrieve attachment 1") do
    ...
    work_order_entry = @@remedy_forms['WOI:WorkOrder'].find_entries(
      :single,
	...
	entry = @@remedy_forms['WOI:WorkInfo'].create_entry!(
