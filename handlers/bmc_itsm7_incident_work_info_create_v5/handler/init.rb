...
class BmcItsm7IncidentWorkInfoCreateV5
  ...
  def initialize(input)
    ...
    preinitialize_on_first_load(
      @input_document,
      ['KS_SRV_SurveyQuestion', 'KS_SRV_QuestionAnswerJoin', 'KS_ACC_Attachment', 'HPD:WorkLog', 'HPD:Help Desk']
    )
  ...
  def execute
    ...
    incident_entry = @@remedy_forms['HPD:Help Desk'].find_entries(
      :single,
	...
	entry = @@remedy_forms['HPD:WorkLog'].create_entry!(
