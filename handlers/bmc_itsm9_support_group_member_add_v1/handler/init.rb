...
class BmcItsm9SupportGroupMemberAddV1
  ...
  def execute()
    ...
    if token.length == 3  # for example 401 404 500...
	  ...
	  create_route = "#{api_server}/arsys/v1/entry/CTM:Support%20Group%20Association"
      ...
      response = RestClient::Request.new({
		...
		if response.code == 201
          ...
          newitem_request_id = newitem_parsed["values"]["Support Group Association ID"]  
    ...
    <results>
	  ...
	  <result name="Support Group Association ID">#{newitem_request_id}</result>
    </results>
    RESULTS
